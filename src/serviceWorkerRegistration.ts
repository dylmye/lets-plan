    ...
    window.addEventListener("load", () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.debug("[Service Worker] We're in 😎");
        });
      } else {
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === "installed") {
            if (navigator.serviceWorker.controller) {
              ...
              console.debug(
                "[Service Worker] Caching will resume when other instances have been closed"
              );
              ...
              console.debug("[Service Worker] Content cached successfully");
...
function checkValidServiceWorker(swUrl: string, config?: Config) {
  ...
  fetch(swUrl, {
    ...
    .catch(() => {
      console.debug("[Service Worker] Running in offline mode");
    });
}
